...
plotA <- plot(richnessCurrent, box = F, axes = F, range = c(0, 100), plg = list(title = "Species", title.cex = 0.5, cex = 0.5, size = c(0.75, 0.5)), mar = c(1.5, 1.5, 1.5, 1.5), buffer = F, cex.main = 0.75)
sbar(1000000, "bottomleft", type = "bar", labels = c("", "1,000 km", ""), cex = 0.5)
plot(countries, add = T)
mtext(expression(bold("a")), side = 3, adj = 0)
plotB <- plot(richnessFuture, box = F, axes = F, range = c(0, 100), plg = list(title = "Species", title.cex = 0.5, cex = 0.5, size = c(0.75, 0.5)), mar = c(1.5, 1.5, 1.5, 1.5), buffer = F, cex.main = 0.75)
sbar(1000000, "bottomleft", type = "bar", labels = c("", "1,000 km", ""), cex = 0.5)
plot(countries, add = T)
mtext(expression(bold("b")), side = 3, adj = 0)
plotC <- plot(richnessAbs, box = F, axes = F, range = c(-50, 50), plg = list(title = "Richness change\n(species)", title.cex = 0.5, cex = 0.5, size = c(0.75, 0.5)), mar = c(1.5, 1.5, 1.5, 1.5), buffer = F, cex.main = 0.75)
sbar(1000000, "bottomleft", type = "bar", labels = c("", "1,000 km", ""), cex = 0.5)
plot(countries, add = T)
mtext(expression(bold("c")), side = 3, adj = 0)
plotD <- plot(richnessRel, box = F, axes = F, range = c(0, 2), plg = list(title = "Richness change\n(relative)", title.cex = 0.5, cex = 0.5, size = c(0.75, 0.5)), mar = c(1.5, 1.5, 1.5, 1.5), buffer = F, cex.main = 0.75)
sbar(1000000, "bottomleft", type = "bar", labels = c("", "1,000 km", ""), cex = 0.5)
plot(countries, add = T)
